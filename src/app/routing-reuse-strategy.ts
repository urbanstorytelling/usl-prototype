 ...
 * reuse-strategy.ts
 * by corbfon 1/6/17
 * https://stackoverflow.com/a/41515648/3249027
 *
 * TODO:
 *  - not store all routs, f.e. not for details of idea, see example in SO post
 */
...
export class RoutingReuseStrategy implements RouteReuseStrategy {
     ...
     * An idea of what to do here: check the route.routeConfig.path to see if it is a path you would like to store @param route
    ...
    store(route: ActivatedRouteSnapshot, handle: DetachedRouteHandle): void {
        ...
        /**
         * routes are stored by path - the key is the path name, and the handle is stored under it so that you can only ever have
         * one object stored for a single path
         */
    ...
    shouldAttach(route: ActivatedRouteSnapshot): boolean {
        ...
        if (canAttach) {
            ...
            console.log('deciding to attach...', route, 'does it match?', this.storedRoutes[route.routeConfig.path].snapshot,
